...
## Generated on : Thu Dec 26 11:35:57 2024
## Final product: $(START_DIR)/mainODE
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/exe/mainODE -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include
...
SRCS = $(START_DIR)/codegen/exe/mainODE/rt_nonfinite.c $(START_DIR)/codegen/exe/mainODE/rtGetNaN.c $(START_DIR)/codegen/exe/mainODE/rtGetInf.c $(START_DIR)/codegen/exe/mainODE/mainODE_initialize.c $(START_DIR)/codegen/exe/mainODE/mainODE_terminate.c $(START_DIR)/codegen/exe/mainODE/mainODE.c $(START_DIR)/codegen/exe/mainODE/mainODE_emxutil.c $(START_DIR)/codegen/exe/mainODE/mainODE_emxAPI.c
...
OBJS = rt_nonfinite.o rtGetNaN.o rtGetInf.o mainODE_initialize.o mainODE_terminate.o mainODE.o mainODE_emxutil.o mainODE_emxAPI.o
...
%.o : $(START_DIR)/codegen/exe/mainODE/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/exe/mainODE/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/exe/mainODE/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/exe/mainODE/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/exe/mainODE/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rt_nonfinite.o : $(START_DIR)/codegen/exe/mainODE/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/codegen/exe/mainODE/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/codegen/exe/mainODE/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mainODE_initialize.o : $(START_DIR)/codegen/exe/mainODE/mainODE_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mainODE_terminate.o : $(START_DIR)/codegen/exe/mainODE/mainODE_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mainODE.o : $(START_DIR)/codegen/exe/mainODE/mainODE.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mainODE_emxutil.o : $(START_DIR)/codegen/exe/mainODE/mainODE_emxutil.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mainODE_emxAPI.o : $(START_DIR)/codegen/exe/mainODE/mainODE_emxAPI.c
	$(CC) $(CFLAGS) -o "$@" "$<"
