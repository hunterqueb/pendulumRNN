...
plotOrbitPhasePredictions(numericResultDefault)
plotOrbitPhasePredictions(numericResultHigh)


output_seq = numericResult

pertNR = numericResultHigh

def plotPreditionODE(numericResultDefault,numericResultHigh):

        numericResultDefault = nonDim2Dim4(numericResultDefault)
        numericResultHigh = nonDim2Dim4(numericResultHigh)
        ...
        err = numericResultDefault - numericResultHigh
        ...
        # filter out nan values for better post processing
        return
plotPreditionODE(numericResultDefault,numericResultHigh)
